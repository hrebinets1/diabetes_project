...
class MedicTests(TestCase):
    ...
    def test_patient_info_on_medic_page(self):
        ...
        self.assertContains(response, "10") # create in setUp function
        self.assertContains(response, "5.5")

    def test_unique_patient_info_on_medic_page(self):
        med_pass = "unique_password_321"
        med = CustomUser.objects.create_user(
            username="unique_medic_test",
            role="medic",
